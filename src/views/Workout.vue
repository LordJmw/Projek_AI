...
import { useTypingText } from '@/composables/useTypingText.js';
...
<template>
  <div class="bg-gray-200"> <!-- Set the background color for the whole page to light gray -->
    ...
    <section class="bg-gray-200 py-16 px-6">
      <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 text-gray-800">
        ...
        <div class="flex-1 bg-cover bg-center rounded-xl p-6 bg-[url('./../assets/cam.jpg')] min-h-[300px] justify-betweeen relative"></div>
